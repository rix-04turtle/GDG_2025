      ...
      <main className="flex-grow flex items-center justify-center">
        ...
        >
          <CardHeader className="text-center pb-2">
            <CardTitle className="text-3xl font-extrabold text-primary mb-1">Sign Up</CardTitle>
            <CardDescription className="text-base text-slate-600">Enter your details to create an account</CardDescription>
          </CardHeader>
          <CardContent>
